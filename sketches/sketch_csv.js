...
//con esto voy a contar hombres y mujeres muertos en primera clase
...
//con esto voy a contar hombres y mujeres muertos en segunda clase
for (var c = 0; c < data.getRowCount(); c++) {
...
print("murieron "+muerta_en_segunda+" mujeres en segunda clase")
print("murieron "+muerto_en_segunda+" hombres en segunda clase")

var muerto_en_tercera= 0;
var muerta_en_tercera= 0;
//con esto voy a contar hombres y mujeres muertos en tercera clase
for (var c = 0; c < data.getRowCount(); c++) {
...
print("murieron "+muerta_en_tercera+" mujeres en segunda clase")
print("murieron "+muerto_en_tercera+" hombres en segunda clase")
